...
class ComponentButtonPrimaryWithFunction extends StatelessWidget {
  String? buttonName;
  Function? func;
  Color? colorButton = ColorApp.ColorButtonPrimary;
  double? sizeTextButton = SizeApp.SizeTextDescription;
  String? routeName;
  Color? colorText = ColorApp.primary;

  ComponentButtonPrimaryWithFunction(this.buttonName, this.func,
      {this.colorButton, this.sizeTextButton, this.routeName, this.colorText});
  @override
  Widget build(BuildContext context) {
    return _Button(context, func, buttonName);
  }
...
class ComponentButtonPrimaryOutlineWithFunction extends StatelessWidget {
  String? buttonName;
  Function? func;
  Color? colorButton = ColorApp.ColorButtonOutline;
  double? sizeTextButton = SizeApp.SizeTextDescription;
  String? routeName;

  ComponentButtonPrimaryOutlineWithFunction(this.buttonName, this.func,
      {this.colorButton, this.sizeTextButton, this.routeName});
